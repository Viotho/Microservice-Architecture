package com.jackyzeng.auth.tokenStore;


import com.jackyzeng.auth.converter.CustomUserAuthenticationConverter;
import com.jackyzeng.common.constants.SecurityConstants;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "configs.oauth2.token.store", name = "type", havingValue = "resourceJwt")
